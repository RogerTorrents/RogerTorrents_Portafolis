 ...
 * comptes del `confirm()` natiu del navegador (no encaixa amb l'estètica de
 * l'app). `demanar(...)` retorna una `Promise<boolean>` que es resol quan
 * l'usuari prem "Confirmar" o "Cancel·lar" al `ConfirmacioDialeg` muntat a
 * l'arrel de l'app.
 */
