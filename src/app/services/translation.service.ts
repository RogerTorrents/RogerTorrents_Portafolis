...
export class TranslationService {
  ...
  private readonly dict: Record<string, Record<string, string>> = {
    ca: {
      ...
      start_tancar: 'Tancar',
      app_joc_impostor: "L'Impostor",
      placeholder_joc_impostor: "Aquí anirà tot el contingut de L'Impostor.",
      app_som_hi: 'Som-hi',
      placeholder_som_hi: "Aquí anirà tot el contingut de Som-hi.",
    ...
    es: {
      ...
      start_reiniciar: 'Reiniciar',
      start_tancar: 'Cerrar',
      app_joc_impostor: 'El Impostor',
      placeholder_joc_impostor: 'Aquí irá todo el contenido de El Impostor.',
      app_som_hi: 'Som-hi',
      placeholder_som_hi: 'Aquí irá todo el contenido de Som-hi.',
      app_geoexplorer: 'GeoExplorer',
    ...
    en: {
      ...
      start_tancar: 'Close',
      app_joc_impostor: 'The Impostor',
      placeholder_joc_impostor: "Here will go all of The Impostor's content.",
      app_som_hi: 'Som-hi',
      placeholder_som_hi: "Here will go all of Som-hi's content.",
      app_geoexplorer: 'GeoExplorer',
